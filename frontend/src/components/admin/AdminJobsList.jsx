              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-base text-slate-900">
                    {selectedJob.companyProfile?.companyName || "N/A"}
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-base text-slate-900">
                    {selectedJob.provider?.name || "N/A"} (
                    {selectedJob.provider?.email})
                  </p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <span
                    className={`inline-block mt-1 px-3 py-1 rounded-full text-xs font-medium capitalize ${
