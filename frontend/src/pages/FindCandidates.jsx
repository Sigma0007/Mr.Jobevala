              ...
              <div className="mb-8">
                ...
                <div className="space-y-3.5">
                  {categoriesType.map((cat) => (
                    ...
                    >
                      <div
                        className={`w-4 h-4 rounded border flex items-center justify-center transition-colors ${selectedCategories.includes(cat.value) ? "border-blue-600 bg-blue-50" : "border-slate-300 bg-white group-hover:border-blue-500"}`}
                      >
                        <CheckCircle2
                          className={`w-3.5 h-3.5 text-blue-600 transition-opacity ${selectedCategories.includes(cat.value) ? "opacity-100" : "opacity-0 group-hover:opacity-50"}`}
                        />
                      </div>
                      ...
                      <input
                        ...
                        onChange={() =>
                          handleFilterChange(setSelectedCategories, cat.value)
                        }
                      />
                    </label>
                  ))}
              ...
              <div className="mb-8">
                ...
                <div className="space-y-3.5">
                  {EXPERIENCE_LEVELS.map((exp) => (
                    ...
                    >
                      <div
                        className={`w-4 h-4 rounded-full border flex items-center justify-center transition-colors ${selectedExperience.includes(exp.value) ? "border-blue-600 bg-blue-50" : "border-slate-300 bg-white group-hover:border-blue-500"}`}
                      >
                        <div
                          className={`w-2 h-2 rounded-full bg-blue-600 transition-opacity ${selectedExperience.includes(exp.value) ? "opacity-100" : "opacity-0 group-hover:opacity-50"}`}
                        />
                      </div>
                      <span className="text-sm font-medium text-slate-600 group-hover:text-slate-900 transition-colors">
                        {exp.label}
                      ...
                      <input
                        ...
                        onChange={() =>
                          handleFilterChange(setSelectedExperience, exp.value)
                        }
                      />
                    </label>
                  ))}
              ...
              <div className="mb-8">
                ...
                <div className="space-y-3.5">
                  {workModeType.map((mode) => (
                    ...
                    >
                      <div
                        className={`w-4 h-4 rounded border flex items-center justify-center transition-colors ${selectedWorkModes.includes(mode.value) ? "border-blue-600 bg-blue-50" : "border-slate-300 bg-white group-hover:border-blue-500"}`}
                      >
                        <CheckCircle2
                          className={`w-3.5 h-3.5 text-blue-600 transition-opacity ${selectedWorkModes.includes(mode.value) ? "opacity-100" : "opacity-0 group-hover:opacity-50"}`}
                        />
                      </div>
                      <span className="text-sm font-medium text-slate-600 group-hover:text-slate-900 transition-colors">
                        {mode.label}
                      ...
                      <input
                        ...
                        onChange={() =>
                          handleFilterChange(setSelectedWorkModes, mode.value)
                        }
                      />
                    </label>
                  ))}
              ...
              <div className="mb-8">
                ...
                <div className="space-y-3.5">
                  {jobType.map((type) => (
                    ...
                    >
                      <div
                        className={`w-4 h-4 rounded border flex items-center justify-center transition-colors ${selectedJobTypes.includes(type.value) ? "border-blue-600 bg-blue-50" : "border-slate-300 bg-white group-hover:border-blue-500"}`}
                      >
                        <CheckCircle2
                          className={`w-3.5 h-3.5 text-blue-600 transition-opacity ${selectedJobTypes.includes(type.value) ? "opacity-100" : "opacity-0 group-hover:opacity-50"}`}
                        />
                      </div>
                      <span className="text-sm font-medium text-slate-600 group-hover:text-slate-900 transition-colors">
                        {type.label}
                      ...
                      <input
                        ...
                        onChange={() =>
                          handleFilterChange(setSelectedJobTypes, type.value)
                        }
                      />
                    </label>
                  ))}
              ...
              <div>
                ...
                <div className="space-y-3.5">
                  {SalaryRangeType.map((range) => (
                    ...
                    >
                      <div
                        className={`w-4 h-4 rounded-full border flex items-center justify-center transition-colors ${selectedSalaryRanges.includes(range.value) ? "border-blue-600 bg-blue-50" : "border-slate-300 bg-white group-hover:border-blue-500"}`}
                      >
                        <div
                          className={`w-2 h-2 rounded-full bg-blue-600 transition-opacity ${selectedSalaryRanges.includes(range.value) ? "opacity-100" : "opacity-0 group-hover:opacity-50"}`}
                        />
                      </div>
                      <span className="text-sm font-medium text-slate-600 group-hover:text-slate-900 transition-colors">
                        {range.label}
